...
{
	PlanState	ps;             /* base class for all plan nodes */
	JoinType	jointype;       /* type of join */
	bool		single_match;   /* for outer joins, stop after first match? */
...
{
	JoinState	js;				/* its first field is NodeTag */
	ExprState  *hashclauses;	/* join clauses involving = operator */
	List	   *hj_OuterHashKeys;	/* hash keys for outer table */
	List	   *hj_InnerHashKeys;	/* hash keys for inner table */
